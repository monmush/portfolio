...
export const meta = {
  ...
  image:
    "https://images.unsplash.com/photo-1467106130188-af373dea5412?q=80&w=3270&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&fit=crop&crop=edges",
