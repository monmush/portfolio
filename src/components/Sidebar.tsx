      ...
      <AnimatePresence>
        {open && (
          <motion.div
            ...
            exit={{ x: -300 }}
            className="px-6 z-[100] py-8 md:py-10 bg-neutral-100 max-w-[14rem] lg:w-fit fixed lg:relative h-screen left-0 flex flex-col justify-between"
          >
            <div className="flex-1 overflow-auto">
              <SidebarHeader />
              <Navigation setOpen={setOpen} />
            </div>
            <div className="pt-2" onClick={() => isMobile() && setOpen(false)}>
...
const SidebarHeader = () => {
  return (
    <div className="flex space-x-2">
      <div className="relative bg-white h-16 w-16 overflow-hidden rounded-full flex-shrink-0">
        <Image
          src="/images/104769.jpeg"
          alt="Avatar"
          fill
          quality={100}
